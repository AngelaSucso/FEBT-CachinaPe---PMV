...
<head>
  ...
  <!-- Custom StyleSheet -->
  <title>CachinaPe | Detalles del producto</title>
...
<ul class="menu">
    <li><a href="../seller/sellerMain.php" style="color:#f5a623;font-weight:bold;">Centro de Vendedores</a></li>
    <li><a href="buyerMain.php">Inicio</a></li>
    <li><a href="buyerProduct.php">Producto</a></li>
<li><a href="order.php">Pedido</a></li>
<li><a href="buyerProfile.php">Perfil</a></li>
    ...
    <div class="details container-md">
      ...
      <div class="right">
        ...
        <form class="form" method="POST">
          ...
          <input type="submit" value="Añadir al carrito" class="addCart" name="addcart" id="addcart">
        ...
        <?php if($email!=$seller_id){?>
          <form method="post" action="chat.php?pid=<?php echo $seller_id; ?>">
            ...
            <i class='fa fa-weixin' style="font-style:normal;color:#ee4d2d;font-size:24px;">&nbsp;Conversa con el Vendedor</i>
            </button>
          </form>
          <?php } ?>
      </div>
