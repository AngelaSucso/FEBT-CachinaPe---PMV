...
<body style="background:#edf0f2;">
	    ...
	    <ul class="menu">
            <li><a href="../buyer/buyerMain.php" style="color:#f5a623;font-weight:bold;">Centro del comprador</a></li>
            <li><a href="sellerMain.php">Inicio</a></li>
            <li><a href="sellerProduct.php">Mis Productos</a></li>
    		<li><a href="sellerOrder.php">Mis Pedidos</a></li>
    		<li><a href="income.php">Mis Ingresos</a></li>
        ...
        <div class="center">
  <div class="btn-group">
    <button onclick="location.href='sellerProduct.php'">Productos</button>
    <button onclick="location.href='addProduct.php'">Agregar Productos</button>
    <button onclick="location.href='pendingList.php'">Pendientes</button>
    <button onclick="location.href='declineList.php'">Denegados</button>
  </div>
</div>
...
<div class="wrapper">
  <div class="contact-form">
    ...
    <input type="text" class="input" name="id" id="id" value="<?php echo $customer_ID; ?>" readonly>
      <input type="text" class="input" id="title" name="title" placeholder="Nombre del Producto" required>
        <select name="category" class="input" id="category" placeholder="Por favor Seleccione Categoría" required>
      ...
      <input name="quantity" id="quantity" type="number" class="input" placeholder="Cantidad" required>
      <input name="price" id="quantity" type="number" class="input" placeholder="Precio" required>
      <br>
