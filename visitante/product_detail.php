...
<head>
  ...
  <!-- Custom StyleSheet -->
  <title>CachinaPe | Product Details</title>
...
<header class="header">
      ...
      <ul class="menu">
            <li><a href="../visitor/register.php" style="color:#f5a623;font-weight:bold;margin-top:-2px;">Registrate ahora!</a></li>
            <li><a href="../index.php" style="color:white;margin-top:-2px;">Inicio</a></li>
            <li><a href="../visitor/vProduct.php" style="color:white;margin-top:-2px;">Producto</a></li>
            <li><a href="../visitor/about_us.php" style="color:white;margin-top:-2px;">Nosotros</a></li>
            <li><a href="../visitor/login.php" style="color:white;margin-top:-2px;">Inicia sesión</a></li>
        </ul>
        </header>
  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        ...
        <form>
          <div>
          <h5 style="color:red;">Stock disponible : <?php echo $quantity; ?></h5>
          </div>
        </form>
        ...
        <br>
        <br>
        <p style="color:blue;">Por favor <a href="login.php" style="color:blue;">Ingresa</a> para comprar este producto.</p>
      </div>
    </div>
  </section>
...
<footer>
  <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script>, CachinaPe</p>
</footer>
