...
<header class="header">
        ...
        <ul class="menu">
            <li><a href="../visitor/register.php" style="color:#f5a623;font-weight:bold;margin-top:-3px;">Registrate ahora!</a></li>
            <li><a style="margin-top:-3px;" href="../index.php">Inicio</a></li>
            <li><a style="margin-top:-3px;" href="../visitor/vProduct.php">Producto</a></li>
            <li><a style="margin-top:-3px;" href="../visitor/about_us.php">Nosotros</a></li>
            <li><a style="margin-top:-3px;" href="../visitor/login.php">Inicia sesión</a></li>
        </ul>
        </header>

<form id="Formid" method="post" action="">
  <div class="search">
          <input type="text" name="search_product" id="search_product" value="<?php echo $keyword ?>" placeholder="Búsqueda de productos, marcas y más...">
  </div>
  ...
  <section class="page-section">
      ...
      <div class="row">
        ...
        <div class="col-lg-9" style="padding-left: 30px;">
          ...
          <div class="form-price-range-filter">
            ...
            <div>
                <input type="submit" name="submit_range" value="Filtrar Producto" class="btn-submit">
                <input type="button" onClick="window.location.href=window.location.href" value="reiniciar" class="btn-submit">
            </div>
        </form>
    </div>
          <div class="row">
    ...
    text-overflow: ellipsis;height:37px;"><?php echo $description;?></p>
                  <p class="tags">S/. <?php echo $price;?></p>
                  
                  <a href="product_detail.php?pid=<?php echo $id;?>" target="_blank" class="btn btn-success button-text"> Más detalles</a>
                            </div>
